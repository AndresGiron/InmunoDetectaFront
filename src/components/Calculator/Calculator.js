...
function Calculadora() {
  ...
  const onSubmit = data => {
    ...
    console.log(data)
    prediccion(data,setResultPredict).then(() => {
      handleShow()
    })
  }
                  ...
                  <Accordion.Body>
                    ...
                    <Row className="mb-3">
                      <Form.Group as={Col} name="Edad al momento del evento">
                        ...
                        <Form.Control {...datos('Edad al momento del evento', { required: true })} 
                        type="number" 
                        placeholder="Edad"
                        defaultValue={18}
                        min={0}
                      ...
                      <Col md={6}>
                        ...
                        {useAntiDNA && (
                          <Form.Group name="T_tulos_Anti_DNA_dc_al_ingreso">
                            <Form.Label> Titulos Anti DNA dc</Form.Label>
                            <Form.Control {...datos('T_tulos_Anti_DNA_dc_al_ingreso', { required: false })} className="d-flex justify-content-left mb-2 pl-2" type="number"
                            placeholder="Anti DNA dc"
                            min={0}
                            onKeyDown={handleKeyDownFLoat}
                            onPaste={handlePaste}  />
                          </Form.Group>
